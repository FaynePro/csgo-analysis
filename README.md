...
git clone https://github.com/faynepro/csgo-analysis
cd csgo-analysis
...
| `src/R/*.R`                        | R scripts that runs descriptive and inferential analyses on the generated timeseries data                              |

## Usage - new src

### Pipeline 

To run the various machine learning models and do a proper comparison, make sure to run `app.py`. This will guide you through running the:
1. Parsing layer - (note that running `create_graphs.py` can take a long time, and is recommended to run seperately)
2. Splitting layer
3. Model layer